...
use App\Models\DetalVenta\DetalleVenta;
...
class VentaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $mytime= Carbon::now('America/Panama');
    ...
    public function pdf(Request $request, $id){
        ...
        return $pdf->download('venta-'.$numventa[0]->num_comprobante.'.pdf'); //El nombre va ser venta- el indice 0 del array numventa lo que tengo en la propiedad num_comprobante
