...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <div id="datos">
                <p id="encabezado">
                    <b>Empresa:</b><br>Nombre:<br>Telefono:<br>Email:
                </p>
            </div>
            <div id="fact">
                ...
                <table id="facliente">
                    ...
                    <tbody>
                        <tr>
                            ...
                            DirecciÃ³n: {{$v->direccion}}<br>
                            TelÃ©fono: {{$v->telefono}}<br>
                            Email: {{$v->email}}</</p></th>
                        </tr>
                    </tbody>
                </table>
                ...
                <table id="facarticulo">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th></th>
                            <th>SUBTOTAL</th>
                            <td>$ {{round($v->total-($v->total*$v->impuesto),2)}}</td><!--round para redondear y lo redondeo a 2 decimales-->
                        </tr>
                        <tr>
                            <th></th>
                            <th></th>
