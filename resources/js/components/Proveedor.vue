                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="telefono_contacto" class="form-control" placeholder="Teléfono del contacto">
                                    </div>
                                </div>
                    ...
                    case "persona":
                    {
                        switch(accion){
                            case 'registrar':
                            {
                                ...
                                this.nombre= '';
                                this.tipo_documento='RUC'; //El tipo de documento va ser RUC por que los proveedores van a ser empresas
                                this.num_documento='';
                                this.direccion='';
                                this.telefono='';
                                this.email='';
